...
namespace MVCWebApp2.Controllers
{
    public class HomeController : Controller
    {
        ...
        [HttpPost]  //you cannot have overloaded methods,but it should have a decraotor like [HttpPost] to have method with same name
      /*  public IActionResult Index(int x)
        {
            ViewData["x"] = x;        //both are dictionary
           // TempData["globalX"] = x;
